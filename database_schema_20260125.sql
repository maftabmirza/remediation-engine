...
\restrict tuOqcDzTyfjBmCxW1f8BqhWKtVnR2Sq5t6QFfaXV8Sw4y2baWcYSObkN6HLog8I
...
ALTER TYPE public.paneltype OWNER TO aiops;
...
ALTER TABLE public.action_proposals OWNER TO aiops;
...
ALTER TABLE public.agent_audit_logs OWNER TO aiops;
...
ALTER TABLE public.agent_pools OWNER TO aiops;
...
ALTER TABLE public.agent_rate_limits OWNER TO aiops;
...
ALTER SEQUENCE public.agent_rate_limits_id_seq OWNER TO aiops;
...
ALTER TABLE public.agent_sessions OWNER TO aiops;
...
ALTER TABLE public.agent_steps OWNER TO aiops;
...
ALTER TABLE public.agent_tasks OWNER TO aiops;
...
ALTER TABLE public.ai_action_confirmations OWNER TO aiops;
...
ALTER TABLE public.ai_feedback OWNER TO aiops;
...
CREATE TABLE public.ai_helper_audit_logs (
    ...
    ai_suggested_action character varying(100),
    ...
    is_error boolean,
    CONSTRAINT ck_ai_audit_execution_result CHECK (((execution_result)::text = ANY ((ARRAY['success'::character varying, 'failed'::character varying, 'blocked'::character varying, 'timeout'::character varying])::text[]))),
    CONSTRAINT ck_ai_audit_user_action CHECK (((user_action)::text = ANY ((ARRAY['approved'::character varying, 'rejected'::character varying, 'modified'::character varying, 'ignored'::character varying, 'pending'::character varying])::text[])))
);


ALTER TABLE public.ai_helper_audit_logs OWNER TO aiops;
...
CREATE TABLE public.ai_helper_sessions (
    ...
    last_activity_at timestamp with time zone,
    created_at timestamp with time zone,
    CONSTRAINT ck_ai_session_status CHECK (((status)::text = ANY ((ARRAY['active'::character varying, 'completed'::character varying, 'abandoned'::character varying, 'error'::character varying])::text[]))),
    CONSTRAINT ck_ai_session_type CHECK (((session_type)::text = ANY ((ARRAY['general'::character varying, 'form_assistance'::character varying, 'troubleshooting'::character varying, 'learning'::character varying])::text[])))
);


ALTER TABLE public.ai_helper_sessions OWNER TO aiops;
...
ALTER TABLE public.ai_messages OWNER TO aiops;
...
ALTER TABLE public.ai_permissions OWNER TO aiops;
...
ALTER TABLE public.ai_sessions OWNER TO aiops;
...
ALTER TABLE public.ai_tool_executions OWNER TO aiops;
...
ALTER TABLE public.alembic_version OWNER TO aiops;
...
ALTER TABLE public.alert_clusters OWNER TO aiops;
...
ALTER TABLE public.alert_correlations OWNER TO aiops;
...
ALTER TABLE public.alerts OWNER TO aiops;
...
ALTER TABLE public.analysis_feedback OWNER TO aiops;
...
ALTER TABLE public.api_credential_profiles OWNER TO aiops;
...
ALTER TABLE public.application_components OWNER TO aiops;
...
ALTER TABLE public.application_knowledge_configs OWNER TO aiops;
...
ALTER TABLE public.application_profiles OWNER TO aiops;
...
ALTER TABLE public.applications OWNER TO aiops;
...
ALTER TABLE public.apscheduler_jobs OWNER TO aiops;
...
ALTER TABLE public.audit_log OWNER TO aiops;
...
ALTER TABLE public.auto_analyze_rules OWNER TO aiops;
...
ALTER TABLE public.blackout_windows OWNER TO aiops;
...
ALTER TABLE public.change_events OWNER TO aiops;
...
ALTER TABLE public.change_impact_analysis OWNER TO aiops;
...
ALTER TABLE public.change_items OWNER TO aiops;
...
ALTER TABLE public.change_sets OWNER TO aiops;
...
ALTER TABLE public.circuit_breakers OWNER TO aiops;
...
ALTER TABLE public.command_allowlist OWNER TO aiops;
...
ALTER TABLE public.command_blocklist OWNER TO aiops;
...
ALTER TABLE public.component_dependencies OWNER TO aiops;
...
ALTER TABLE public.credential_profiles OWNER TO aiops;
...
ALTER TABLE public.dashboard_annotations OWNER TO aiops;
...
ALTER TABLE public.dashboard_links OWNER TO aiops;
...
ALTER TABLE public.dashboard_panels OWNER TO aiops;
...
ALTER TABLE public.dashboard_permissions OWNER TO aiops;
...
ALTER TABLE public.dashboard_snapshots OWNER TO aiops;
...
ALTER TABLE public.dashboard_variables OWNER TO aiops;
...
ALTER TABLE public.dashboards OWNER TO aiops;
...
ALTER TABLE public.design_chunks OWNER TO aiops;
...
ALTER TABLE public.design_documents OWNER TO aiops;
...
ALTER TABLE public.design_images OWNER TO aiops;
...
ALTER TABLE public.execution_outcomes OWNER TO aiops;
...
ALTER TABLE public.execution_rate_limits OWNER TO aiops;
...
ALTER TABLE public.failure_patterns OWNER TO aiops;
...
ALTER TABLE public.file_backups OWNER TO aiops;
...
ALTER TABLE public.file_versions OWNER TO aiops;
...
ALTER TABLE public.grafana_datasources OWNER TO aiops;
...
ALTER TABLE public.group_members OWNER TO aiops;
...
ALTER TABLE public.groups OWNER TO aiops;
...
ALTER TABLE public.incident_metrics OWNER TO aiops;
...
ALTER TABLE public.iteration_loops OWNER TO aiops;
...
ALTER TABLE public.itsm_integrations OWNER TO aiops;
...
CREATE TABLE public.knowledge_sync_history (
    ...
    created_at timestamp with time zone,
    CONSTRAINT ck_sync_history_status CHECK (((status)::text = ANY ((ARRAY['running'::character varying, 'success'::character varying, 'failed'::character varying, 'partial'::character varying])::text[])))
);


ALTER TABLE public.knowledge_sync_history OWNER TO aiops;
...
ALTER TABLE public.llm_providers OWNER TO aiops;
...
ALTER TABLE public.panel_rows OWNER TO aiops;
...
ALTER TABLE public.playlist_items OWNER TO aiops;
...
ALTER TABLE public.playlists OWNER TO aiops;
...
ALTER TABLE public.prometheus_datasources OWNER TO aiops;
...
ALTER TABLE public.prometheus_panels OWNER TO aiops;
...
ALTER TABLE public.query_history OWNER TO aiops;
...
ALTER TABLE public.roles OWNER TO aiops;
...
ALTER TABLE public.runbook_acls OWNER TO aiops;
...
CREATE TABLE public.runbook_clicks (
    ...
    CONSTRAINT ck_runbook_clicks_source CHECK (((source)::text = ANY ((ARRAY['chat_page'::character varying, 'agent_widget'::character varying, 'alert_detail'::character varying, 'runbook_list'::character varying, 'unknown'::character varying])::text[])))
);


ALTER TABLE public.runbook_clicks OWNER TO aiops;
...
ALTER TABLE public.runbook_executions OWNER TO aiops;
...
ALTER TABLE public.runbook_steps OWNER TO aiops;
...
ALTER TABLE public.runbook_triggers OWNER TO aiops;
...
ALTER TABLE public.runbooks OWNER TO aiops;
...
ALTER TABLE public.schedule_execution_history OWNER TO aiops;
...
ALTER TABLE public.scheduled_jobs OWNER TO aiops;
...
ALTER TABLE public.server_credentials OWNER TO aiops;
...
ALTER TABLE public.server_groups OWNER TO aiops;
...
ALTER TABLE public.solution_outcomes OWNER TO aiops;
...
ALTER TABLE public.step_executions OWNER TO aiops;
...
ALTER TABLE public.system_config OWNER TO aiops;
...
ALTER TABLE public.terminal_sessions OWNER TO aiops;
...
ALTER TABLE public.users OWNER TO aiops;
...
--
-- Name: idx_audit_created; Type: INDEX; Schema: public; Owner: aiops
--
...
--
-- Name: idx_audit_user; Type: INDEX; Schema: public; Owner: aiops
--
...
ALTER TABLE ONLY public.agent_audit_logs
    ADD CONSTRAINT agent_audit_logs_session_id_fkey FOREIGN KEY (session_id) REFERENCES public.agent_sessions(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.agent_audit_logs
    ADD CONSTRAINT agent_audit_logs_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.agent_rate_limits
    ADD CONSTRAINT agent_rate_limits_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: ai_helper_audit_logs ai_helper_audit_logs_session_id_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: aiops
--

ALTER TABLE ONLY public.ai_helper_audit_logs
    ADD CONSTRAINT ai_helper_audit_logs_session_id_fkey1 FOREIGN KEY (session_id) REFERENCES public.ai_helper_sessions(id) ON DELETE SET NULL;
...
\unrestrict tuOqcDzTyfjBmCxW1f8BqhWKtVnR2Sq5t6QFfaXV8Sw4y2baWcYSObkN6HLog8I
