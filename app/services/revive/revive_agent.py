"""
RE-VIVE Quick Help Agent

Simplified agent for RE-VIVE quick help mode.
Based on NativeToolAgent but WITHOUT minimum tool call enforcement.
Use NativeToolAgent for full troubleshooting mode.
"""
...
"""
        ...
        # RE-VIVE Mode: No minimum tool requirement
        # Quick help should answer directly when possible
        ...
        try:
            while iterations < self.max_iterations:
                ...
                if tool_calls:
                    ...
                    # RE-VIVE Mode: No minimum tool enforcement
                    # Quick help can answer directly
