"""
AI Troubleshoot Agent

Dedicated agent for the /ai troubleshooting feature.
Based on the original NativeToolAgent but isolated for independent development.
"""
...
class AiTroubleshootAgent:
    """
    Agent that uses native tool calling capabilities for Troubleshooting.
    ...
    def __init__(
        ...
        """
        Initialize the AI Troubleshoot agent.
    ...
    def _get_system_prompt(self) -> str:
        ...
        base_prompt = """You are the AI Troubleshooter, an advanced SRE Agent from Antigravity.
...
3. **NO ACTION WITHOUT CONTEXT.** Do not Suggest Commands until you have actually called tools to verify context.
