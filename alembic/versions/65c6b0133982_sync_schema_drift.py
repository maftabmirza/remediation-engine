...
def upgrade() -> None:
    ...
    # ai_feedback operations - only if table exists
    if table_exists('ai_feedback'):
        ...
        print("Skipping ai_feedback operations: table does not exist")
    
    # ai_helper_audit_logs operations - only if table exists
    if table_exists('ai_helper_audit_logs'):
        ...
        print("Skipping ai_helper_audit_logs operations: table does not exist")
    
    # ai_helper_config operations - only if table exists
    if table_exists('ai_helper_config'):
        ...
        print("Skipping ai_helper_config operations: table does not exist")
    
    # ai_helper_sessions operations - only if table exists
    if table_exists('ai_helper_sessions'):
        ...
        print("Skipping ai_helper_sessions operations: table does not exist")
